...
export default async function Navbar() {
  ...
  return (
    <nav className="sticky -px-0 inset-x-0 left-0 right-0 top-0 z-[99999] w-full h-14 flex items-center border-b border-blue-800/30 bg-blue-950/80 backdrop-blur-lg">
      <div className="px-6 py-2 max-w-screen-lg mx-auto flex justify-between items-center w-full text-white">
